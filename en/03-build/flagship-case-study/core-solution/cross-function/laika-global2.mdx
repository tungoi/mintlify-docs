---
title: "LAIKA GLOBAL SYSTEM BLUEPRINTS"
---

### **PART 1: ORGANIZATION STRUCTURE & WORKSPACES**
...
### **PART 3: OBJECT RELATIONSHIP MODEL**

#### **3.1. Parent-Child Relationships**

- **Description:** A built-in, strict hierarchy between a standard `Object` and its `Sub-Objects`. This method is best for work breakdown structures.
...
#### **3.2. Global Connections**

- **Description:** A centrally-managed library of reusable relationship _types_ that standardize the _meaning_ of bidirectional relationships across the entire system.
...
#### **3.3. Object Picker Fields**

- **Description:** A flexible field that allows one `Object` to reference one or more other `Objects`. This is the tool used to _implement_ the relationships defined above.
- **Application at LAIKA:**
...
#### **3.4. Data Table Fields**

- **Description:** An embedded 'spreadsheet' within an `Object` to manage structured lists of data, ideal for modeling 'contained' one-to-many data.
- **Application at LAIKA:**
...
### **PART 4: WORKVIEWS, DASHBOARDS, FILTERS & REMINDERS**
...
### **PART 5: GLOBAL LOGIC & AUTOMATION**

#### **5.1. Cross-system Automation**

- **Description:** Rules that connect Luklak with external applications and services (e.g., Website, Google, SEPAY, Email).
...
#### **5.2. Cross-function Automation**

- **Description:** Rules that orchestrate and transfer work between different departments _inside_ the Luklak platform.
...
#### **6.1. Layer 1: Business Privilege**

- **Description:** This is the highest level of permissions, acting as the "entry ticket" to the entire system and defining a user's maximum potential authority.
...
#### **6.2. Layer 2: Principles for Item Access**

- **Description:** These principles act as a guide for Administrators when assigning access to the "containers" of work and shared assets.
...
#### **6.3. Layer 3: Permission & Notification Schemes**

- **Description:** This is the most granular layer of control, defining "who can do what" and "who gets notified about what" for each individual Object within a Space.
