...
- **Example**: A demo titled "`LAIKA x Sarah & Michael Westbrook - Interior Renovation Demo`" is scheduled for `June 18th at 2 PM`, with `designer Max` and `sales rep David`
...
<Tabs>
  <Tab title="Internal Automations">
