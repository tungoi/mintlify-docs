...
<Tabs>
  ...
  <Tab title="Status Details">
    ...
    | :-------------- | :-------------------------------------------------------------------- |
    | 1. PREPARATION  | Initial project setup, including contract review and team assignment. |
    | 2. DESIGN       | The 3D design and technical drawing phase is underway.                |
    | 3. CONSTRUCTION | On-site construction and installation are in progress.                |
    | 4. FINALIZATION | Financial settlement and final paperwork are being completed.         |
    | 5. HANDOVER     | The completed project is officially handed over to the client.        |
...
<Tabs>
  ...
  <Tab title="Status Details">
    ...
    | 2. IN PROGRESS | Work on the tasks within this category has started.                  |
    | 3. ACCEPTANCE  | The work is complete and awaiting quality inspection and acceptance. |
    | 4. COMPLETED   | The category has been inspected and officially marked as complete.   |
  </Tab>
  <Tab title="Data Fields">
    | Group                | Field Name (Type)                                                       |
    | :------------------- | :---------------------------------------------------------------------- |
...
<Tabs>
  ...
  <Tab title="Status Details">
    ...
    | 2. APPROVED  | The request has been approved by the project manager.     |
    | 3. PURCHASED | The material has been ordered and paid for.               |
