...
- [**Learn to visualize your data → Gaining Insights with Reports & Dashboards**](https://www.google.com/search?q=/use-and-operate/reports-and-dashboards)
- [**Review the basics of working with Objects → Managing Objects: The Heart of Daily Work**](https://www.google.com/search?q=/use-and-operate/working-with-objects)
