...
- [**Learn more about Global Item Access Control**](/platform/global-settings/item-access)
...
- [**Ready to design your first solution? Go to Build Playbooks**](/build-playbooks)
- [**Need to refresh your memory on the components? Revisit the Core LEGO Pieces**](/platform/core-concepts)