...
- [**Explore the raw materials → Dive into the Tier 1 Core Blocks**](/platform/core-concepts)
- [**Learn to design blueprints → Go to the Function Design Playbooks**](/platform/function-design)
- [**See how teams work → Explore Tier 3: Usage & Operation Guides**](/use-and-operate)