...
- **Review the complete security model:** [**Return to the Permissions Overview**](https://www.google.com/search?q=/platform/core-concepts/permissions/)
- **Refresh your knowledge on the parallel concept:** [**Review How Permission Schemes Work**](https://www.google.com/search?q=/platform/core-concepts/permissions/permission-schemes)
- **See how notifications interact with automation:** [**Learn about Universal Automation**](https://www.google.com/search?q=/platform/core-concepts/universal-automation)