...
-   **Start with the foundation:** [**Managing People: Users, Groups, and Roles**](/platform/core-concepts/permissions/users-groups-roles)
-   **Explore the first layer of security:** [**Layer 1: System Access with Business Privileges**](/platform/core-concepts/permissions/business-privileges)
-   **See how granular control works:** [**Layer 3: Granular Control with Permission Schemes**](/platform/core-concepts/permissions/permission-schemes)