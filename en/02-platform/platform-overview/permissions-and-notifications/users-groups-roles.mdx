...
- **Assign their system-wide power:** [**Tier 1: System Access with Business Privileges**](/en/02-platform/platform-overview/permissions-and-notifications/business-privileges)
- **Define what Roles can do:** [**Tier 3: Granular Control with Permission Schemes**](/en/02-platform/platform-overview/permissions-and-notifications/permission-schemes)
