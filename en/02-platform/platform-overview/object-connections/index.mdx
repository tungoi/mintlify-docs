...
- [**For strict hierarchies: Parent-Child Relationships**](/en/02-platform/platform-overview/object-connections/parent-child-relationships)
- [**For flexible references: Using Object Picker Fields**](/en/02-platform/platform-overview/object-connections/lookup-connections)
- [**For enterprise consistency: Managing Global Connections**](/en/02-platform/platform-overview/object-connections/global-connections)
- [**For contained lists: Modeling with Data Tables**](/en/02-platform/platform-overview/object-connections/data-table-fields)