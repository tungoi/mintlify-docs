...
- [**See practical examples in our Build Playbooks**](/en/03-build/introduction)
- [**Return to the Core Concepts Overview**](/en/02-platform/platform-overview/the-build-layer)