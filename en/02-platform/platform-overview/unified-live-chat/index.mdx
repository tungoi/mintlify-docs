...
<Frame caption="Chat on Object - never lose context">
...
- [**Learn about private messaging: Level 1: Personal & Group Chat**](/en/02-platform/platform-overview/unified-live-chat/personal-chat)
- [**Learn about team channels: Level 2: Space Chat**](/en/02-platform/platform-overview/unified-live-chat/space-chat)
- [**Master contextual conversations: Level 3: Object Chat**](/en/02-platform/platform-overview/unified-live-chat/object-chat)
- [**Explore powerful tools: Advanced Chat Features**](/en/02-platform/platform-overview/unified-live-chat/chat-features)