...
<Info>
  ...
  → [**Deep Dive: Building Conditions with UQL**](/platform/core-concepts/universal-automation/building-conditions)
</Info>

## UQL in the 'Action' Block (Advanced)

Beyond the Condition block, UQL also plays a critical role in some `Action` steps. When an action needs to **`find or update other 🧊 Objects`**, you can use UQL to specify exactly _which_ `Objects` to act upon.
...
- [**Become a power user: Advanced UQL**](/en/02-platform/platform-overview/filter-and-uql/advanced-uql)
