---
title: "The Luklak Glossary: A Guide to the Build & Ground Layers"
description: "A comprehensive glossary of all key terms in the Luklak platform, organized by the two core architectural layers: the Build Layer and the Ground Layer."
...
<CardGroup cols={3}>
  ...
  <Card title="Unified Live Chat" icon="comments" iconType="duotone">
    ...
    ![Livechat On Object Pn](/images/02-platform/livechat-on-object.png)
