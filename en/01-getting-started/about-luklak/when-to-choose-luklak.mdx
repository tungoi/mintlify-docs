...
<CardGroup cols={2}>
  <Card title="You've Outgrown Out-of-the-box Software">
...
- [Understand the Luklak Philosophy](https://docs.luklak.com/en/01-getting-started/about-luklak/philosophy)
- [Onboarding for Solution Architects](https://docs.luklak.com/en/01-getting-started/role-based-onboarding/for-solution-consultants)
- [Onboarding for CEOs & Executives](https://docs.luklak.com/en/01-getting-started/role-based-onboarding/for-ceos-executives)